...
class BatchedHistory(keras.callbacks.Callback):
    ...
    def __init__(self, *, metrics=None, reduced=True, output_path=None):
        ...
        -----
            ...
            np.load(str(output_path+'batched_history.npz'), allow_pickle=True)['batch_history']
    ...
    def save_history(self, output_path=""):
        ...
        np.savez(str(Path(output_path).joinpath("batched_history.npz")), batch_history=self.history)
